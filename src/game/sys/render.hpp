...
private:
    ...
    constexpr void drawBoxLines(const BoundingBox_t& box, uint32_t x, uint32_t y, uint32_t color) const noexcept;
    ...
    constexpr void drawFullBox(const BoundingBox_t& box, uint32_t x, uint32_t y, uint32_t color) const noexcept;
